...
[image]: ./img/review.PNG "positive Review"

# Deploying a Sentiment Analysis Web App
...
1. Clone the repository and navigate to the downloaded folder.
	```
		git clone https://github.com/sbhadana/Deploying-a-Sentiment-Analysis-Model
	```
2. Open the `SageMaker Project.ipynb` file. You can find HTML version of the file.
	```
